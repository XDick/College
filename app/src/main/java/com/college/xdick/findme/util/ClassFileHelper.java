...
final public  class ClassFileHelper {
    private Context mContext;
   static private String SDPATH;
   ...
   public boolean isSDCardState(){
     ...
     * @param fileName
     */
   static public boolean deleteSDFile(String fileName) {
        File file = new File(SDPATH + fileName);
    ...
    static public boolean copySDFileTo(String srcFileName, String destFileName) throws IOException {
    ...
    static public boolean copyFileTo(File srcFile, File destFile) throws IOException {
