...
public class GridViewAddImagesAdapter extends BaseAdapter {
    ...
    public GridViewAddImagesAdapter(List<Uri> datas, Context context) {
        this.datas = datas;
    ...
    public void notifyDataSetChanged(List<Uri> datas) {
        this.datas = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_choose_grid, parent, false);
        ...
        if (datas != null && position < datas.size()) {
            final Uri file = datas.get(position);
