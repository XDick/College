...
public class ActivityAdapter4 extends RecyclerView.Adapter<ActivityAdapter4.ViewHolder>
      //  implements ItemTouchHelperAdapter
{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView title,time,join,hostInfo,gpsInfo;
        ImageView cover;
        CardView cardView;
        ...
        public ViewHolder(View view){
         ...
         hostInfo = view.findViewById(R.id.host_info);
           gpsInfo = view.findViewById(R.id.gps_info);
        }
    ...
    public ActivityAdapter4(List<MyActivity> activity){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_TYPE_HEADER) {
            ...
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_activity4, parent, false);
            final ViewHolder holder = new ActivityAdapter4.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final ActivityAdapter4.ViewHolder holder, int position) {
        ...
        final MyActivity activity = mActivityList.get(realPos);
         ...
         holder.gpsInfo.setText(activity.getGps()[2]);

         holder.hostInfo.setText(activity.getHost().getUsername()+'\n'+activity.getHostSchool());
